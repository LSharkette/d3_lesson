...
document.getElementById("change-y").onchange = changeY;
...
document.getElementById("change-r").onchange = changeR;
...
document.getElementById("change-color").onchange = changeColor;
